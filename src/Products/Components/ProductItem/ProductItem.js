...
const ProductItem = (props) => {
  ...
  return (
    <Grid item xs={6} sm={6} md={4} lg={4} xl={3} className="productIteminCategory">
      <Link to={`/product/${props.id}`} className={productItemCSS.linkProductItem} style={{ textDecoration: "none" }}>
